...
import { useEncounterById, usePartnerById, removeEncounter } from '@/src/store';
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.actions}>
        <Button title="Edit" variant="secondary" onPress={() => {
          router.push({ pathname: '/(modals)/quick-log', params: { date: encounter.date, emoji: encounter.activities[0] } });
        }} />
