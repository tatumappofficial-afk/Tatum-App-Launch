...
const AddCircleIcon: React.FC<{ size?: number; color?: string; opacity?: number }> = ({
  size = 20,
  color = colors.terra,
  opacity = 0.6,
}) => (
  ...
  return (
    ...
    >
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 24 }}>
        ...
        >
          <AvatarCircle initials={userInitial} gradient={userGradient} size={58} borderWidth={3} />
          <View style={{ flex: 1 }}>
            <Text
              style={{
            ...
            {partners.map((p, i) => (
              ...
              >
                <View style={{ position: 'relative' }}>
                  <AvatarCircle initials={p.initials} gradient={p.gradient} size={44} borderWidth={2} />
                  {p.isMain && (
                    <View
                      style={{
                        position: 'absolute',
