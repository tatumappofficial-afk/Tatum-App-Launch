...
export const LoginAndroidScreen: React.FC = () => (
  ...
  >
    ...
    <View
      pointerEvents="none"
      style={{ position: 'absolute', top: -60, left: '50%', marginLeft: -160, width: 320, height: 320 }}
    >
    ...
    >
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 5 }}>
        <Svg width={16} height={12} viewBox="0 0 16 12" fill="none">
          ...
          <Path
            d="M4.5 7.5C5.6 6.4 6.7 5.8 8 5.8s2.4.6 3.5 1.7"
            stroke={colors.stone}
            strokeWidth={1.4}
            strokeLinecap="round"
            fill="none"
          />
          <Path
            d="M2 5C3.8 3.2 5.8 2.2 8 2.2s4.2 1 6 2.8"
            stroke={colors.stone}
            strokeWidth={1.4}
            strokeLinecap="round"
            fill="none"
